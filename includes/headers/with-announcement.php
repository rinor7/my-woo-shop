...
<body <?php $filename = basename(__FILE__, '.php'); body_class( array( wp_is_mobile() ? 'wp-is-mobile' : 'wp-is-desktop', get_field('sticky', 'option') ? 'header-sticky' : '', $filename ) ); ?>>
    <div id="page" class="site">
            ...
            <header id="header-site" class="site-header announcementbar-header
            <?php 
            ...
            ?>">
            <!-- Announcement NAV -->
            <div class="topbar" id="announcementbar">
            ...
            <!-- Normal NAV -->
            <div class="headerbar header-w-announcementbar" id="headerbar">
                <div class="container-fluid">
                    <div class="menu-here">
