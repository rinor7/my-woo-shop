 ...
 */
 ...
 function standard_scripts_and_style() {
	...
	wp_enqueue_script( 'base-theme-quantity-product-js', get_template_directory_uri() . '/assets/js/woo/qty.js', array(), null, true );
...
require get_template_directory() . '/theme-options/woo-customizers.php';